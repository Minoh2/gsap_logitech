window.addEventListener('DOMContentLoaded', function () {
  ...
  //section04 overlay opacity animation
  gsap.to('.fix-this-4', {
    scrollTrigger: {
  ...
  //section091 header remove class on
  gsap.to('.fix-this-91', {
    scrollTrigger: {
  ...
  //section091 title text slide up animation
  gsap.to('#section091', {
    scrollTrigger: {
      trigger: '#section091',
      start: '-300 top',
  ...
  //section091 mouse image  animation
  ...
  //section05 horizontal scroll animation
  ...
  const video10 = this.document.querySelector('#sc10_video');
  const video11 = this.document.querySelector('#sc11_video');
  ...
  function playVideoSec10(top, vidElmt) {
    gsap.to('#section10', {
      scrollTrigger: {
        ...
        onLeaveBack: () => {
          vidElmt.currentTime = 0; // 비디오 재생시간 0으로 되돌림
          vidElmt.pause();
        },
      },
    });
